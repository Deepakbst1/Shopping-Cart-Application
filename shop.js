if (localStorage.getItem("currentUser") !== null) {
  ...
  // toggle the side bar in ipad and similar form factor devices
  ...
  // automatically toggle the navbar if the user click or scroll the window.
...
function designAddToCartBtn(prod, event1) {
  ...
  parent.style.backgroundColor = "#B68D";
