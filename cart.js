...
if (localStorage.getItem("currentUser") !== null) {
  if (localStorage.getItem("cart") !== null) {
    ...
    payBtn.addEventListener("click", (e) => {
      e.preventDefault();
      var options = {
        key: "rzp_test_xV39ZNbgU1Du4V", //Key ID generated from the Dashboard
        amount: inrPayment * 100, //default currency is INR
        currency: "INR",
        name: "MeShop. Checkout",
        description: "This is your order", //Here is a sample Order ID.
        theme: {
          color: "#122620",
        },
